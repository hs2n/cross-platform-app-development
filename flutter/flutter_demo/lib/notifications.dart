...
/// Manages notifications and displays them in a list
/// Also reads information whether app was started through a notification
///
/// Remark: This is quite a lot of code, as this is the notifications plugin example
/// It is supposed to show off what notifications are possible and how to use them.
/// For an app in production, significantly less code would be used as only
/// a handful of features would be relevant
...
class _NotificationManagerState extends State<NotificationManager> {
            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show plain notification scheduled in 10 seconds',
                    onPressed: () async {
                      await _showNotificationScheduled10();
                    },
                  ),
                  PaddedRaisedButton(
  ...
  Future<void> _showNotificationScheduled10() async {
...
/// A simple raised button, not highly customized (came with the notifications demo)
